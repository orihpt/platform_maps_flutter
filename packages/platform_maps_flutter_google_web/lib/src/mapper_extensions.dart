...
import 'google_map_original.dart' as google_map_original;
import 'google_maps_bitmap_descriptor.dart';
import 'google_maps_platform_controller.dart';
...
extension on Marker {
  google_maps.Marker get googleMapsMarker {
    return google_maps.Marker(
      ...
      onTap: onTap,
      icon: (icon as GoogleMapsBitmapDescriptor?)?.descriptor ?? google_maps.BitmapDescriptor.defaultMarker,
      visible: visible,
      onDragEnd: onDragEnd != null ? (google_maps.LatLng latLng) => _onGoogleMarkerDragEnd(latLng, onDragEnd) : null,
